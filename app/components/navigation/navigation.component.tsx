...
const Navigation = ()=>{
    ...
    const { user } = useUser();
    return(
        <div className="flex lg:flex-row flex-col justify-between shadow-md py-4 bg-amber-100 place-items-center pl-[150px] pr-[150px] fixed top-0 w-full">
            <div className="flex gap-x-2 place-items-center lg:flex-row flex-col">
                ...
                <h1 className="text-gray-700">CodeCrafters Blog</h1>
                <input type="text" className="px-3 py-2 rounded-full ml-2 focus:border-blue-600 focus:outline-none focus:ring focus:ring-green-300 w-[300px] text-sm" placeholder="Search articles here"/>
            </div>
            <nav className="">
                <ul className="flex lg:flex-row flex-col text-gray-700">
                    ...
                    <li className="px-2">
                        <Link href="/" className="hover:text-amber-500">Tutorials</Link>
                    </li>
                    <li className="px-2">
                        <Link href="/" className="hover:text-amber-500">News</Link>
                    </li>
                    <li className="px-2">
